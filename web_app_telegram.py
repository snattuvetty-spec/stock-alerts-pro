...
ALERTS_FILE = "web_alerts_telegram.json"
SETTINGS_FILE = "user_settings_telegram.json"
...
def send_telegram_message(message):
    ...
    try:
        ...
        if not bot_token or not chat_id:
            return False, "Telegram not configured. Check .env file"
...
st.markdown("*Real-time monitoring with Email & Telegram notifications*")
st.markdown("---")
...
with st.sidebar:
    ...
    telegram_enabled = st.checkbox(
        ...
        value=st.session_state.settings.get('telegram_enabled', False),
        help="Get instant alerts on your phone via Telegram"
    )
    ...
    email_enabled = st.checkbox(
        ...
        value=st.session_state.settings.get('email_enabled', False)
    )
